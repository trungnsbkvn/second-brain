...
Recipe default is `bge-m3` (1024d, Y&P prod contract); also lists `nomic-embed-text` (768d), `mxbai-embed-large` (1024d), `all-minilm` (384d). `gbrain providers test --model ollama:bge-m3` smoke-tests the local install.
